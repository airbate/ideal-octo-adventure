	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/airbate",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3537118049601615?spm_id_from=333.1007.0.0",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Twitter",
					url: "https://x.com/qw20060930qw",
					external: true,
...
export const profileConfig: ProfileConfig = {
	...
	name: "AI庄周会不会梦到电子蝴蝶",
	bio: "the meaning of life is not in the answer,but in the footprints along the way",
	links: [
		{
			name: "Bilibli",
			icon: "fa6-brands:bilibili",
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "welcome to my website.", // 公告内容
...
export const musicPlayerConfig: any = {
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to electronic butterfly Website!", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
		...
		link: "https://github.com/airbate", // 关于链接
	},
};
